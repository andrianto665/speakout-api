...
<head>
    <meta charset="utf-8">
    <title>Certificate of Completion - <?php echo e($certificate->certificate_number); ?></title>
    <style>
        @page {
            size: A4 landscape;
            margin: 0;
...
<div class="certificate">
    ...
    <img class="bg-art" src="<?php echo e(public_path('image/certificate-bg-art.png')); ?>" alt="">

    
    <div class="logo-wrap">
        <img src="<?php echo e(public_path('image/logo-palcomtech.png')); ?>" alt="PalComTech">
    </div>
    ...
    <div class="course-instructor">Instructor: <?php echo e($course->instructor); ?></div>

    
    <div class="date">
        Approved on: <?php echo e($certificate->approved_at->format('F j, Y')); ?>
        ...
        <table class="signature-table">
            <tr>
                <td>
                    ...
                    <div class="sig-name"><?php echo e($course->instructor); ?></div>
                    <div class="sig-title">Course Instructor</div>
                </td>
                <td>
                    <div class="sig-line"></div>
                    <div class="sig-name"><?php echo e($admin->name ?? 'Admin PalComTech'); ?></div>
    ...
    <?php if($certificate->approvedBy): ?>
    <div class="admin-info">
        Issued by: <?php echo e($certificate->approvedBy->name); ?> (Admin)
    </div>
    <?php endif; ?>

    
    <div class="certificate-number">No: <?php echo e($certificate->certificate_number); ?></div>

</div>
</body>
</html><?php /**PATH C:\xampp\htdocs\speakout-api\resources\views/certificates/certificate.blade.php ENDPATH**/ ?>